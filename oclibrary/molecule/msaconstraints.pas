...
uses
  Classes, SysUtils, alignment, clustalparser, basetypes, stringutils, debugutils;
...
type
  ...
  TCPMSA=class
    private
      ...
      FMSA:TMSA;
      procedure GenerateConstraints(FileName:string;Threshold:TFLoat);
      procedure GenerateDomains(FileName:string;Window:Integer);
      procedure GenerateQueries(FileName:string;PDBMap:TIntegers);
    public
      ...
      procedure GenerateCP(FileName:string;PDBMap:TIntegers); //creates all files
...
procedure TCPMSA.GenerateCP(FileName: string;PDBMap:TIntegers);
begin
...
procedure TCPMSA.GenerateConstraints(FileName: string; Threshold: TFLoat);
...
var
  buf:TStringList;
  domains:TSimpleStrings;
  maxlength:Integer;

procedure SetDomains(Ix:Integer);

function Combinations(Gaps,AAs:string):TSimpleStrings;
...
procedure TCPMSA.GenerateQueries(FileName: string;PDBMap:TIntegers);
