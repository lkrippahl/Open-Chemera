...
type
  ...
  TDockManager=class
     ...
     procedure BuildRotations(ZStep:Integer;FixedZRotation:TFloat=-1);
...
procedure TDockManager.BuildRotations(ZStep: Integer; FixedZRotation:TFloat=-1);
begin
  if FixedZRotation<0 then
    FRotations:=UniformSampleAngles(ZStep,FAxes)
  else
    FRotations:=FixedZSampleAngles(ZStep,FixedZRotation,FAxes);
  FCurrentRotation:=-1;
end;
