...
type
  ...
  public
    constructor Create(Points:TCoords;GridStep:TFloat);
...
constructor TGeomHasher.Create(Points:TCoords;GridStep:TFloat);
...
procedure Bounds(out B1,B2:Integer; const Val:TFloat; const Hi:Integer);
